...
> [!Note]
> If you using CSOM for .NET Standard with Azure Functions v3 you may encounter a runtime error related to `System.IdentityModel.Tokens.Jwt`. This can be resolved by following the workaround [here](https://github.com/Azure/azure-functions-host/issues/5756).
